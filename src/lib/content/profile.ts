...
> = {
  "zh-TW": {
    ...
    styleTags: ["流行改編", "爵士即興", "動漫 OST", "電影配樂", "即興伴奏"],
  },
  en: {
    ...
    styleTags: ["Pop Arrangement", "Jazz Improv", "Anime OST", "Film Score", "Improvised Accompaniment"],
  },
  ja: {
    ...
    styleTags: ["ポップアレンジ", "ジャズ即興", "アニメOST", "映画音楽", "即興伴奏"],
  },
  ko: {
    ...
    styleTags: ["팝 편곡", "재즈 즉흥연주", "애니 OST", "영화음악", "즉흥 반주"],
  },
};
